...
decompose_problem.sub_aircrafrt_number = 4;
decompose_problem.lambda = zeros(4, nx);
decompose_problem.history_lambda = decompose_problem.lambda;
decompose_problem.initial_update_step = 0.1;
decompose_problem.update_step = decompose_problem.initial_update_step;
...
while decompose_problem.error > 0.015  
    ...
    decompose_problem.error
    decompose_problem.master_error = [decompose_problem.master_error, decompose_problem.error];

    i = i + 1

    decompose_problem.update_step = decompose_problem.initial_update_step/sqrt(i);
    decompose_problem.update_step = decompose_problem.initial_update_step/i;
